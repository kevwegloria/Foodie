...
export default function TermsScreen ({navigation}) {
    return (
        <SafeAreaView style={{flex:1, paddingTop: 60, }}>
            <ScrollView >
                <Text style={{marginLeft: 20, marginBottom: 10, fontSize: 25, color: '#036db0',fontFamily: 'LondrinaSolid-Regular'}}>Terms and Conditions</Text>
                <Text style={{marginLeft: 20,fontSize: 25, color: '#036db0', fontFamily: 'LondrinaSolid-Regular'}}>Welcome to Food<Text style={{fontSize: 25, color: '#ffa914'}}>ie!</Text></Text>
                <Text style={{alignItems: 'center', marginLeft: 20, marginRight: 20, marginTop: 20, lineHeight: 25, fontFamily: 'Montserrat'}}>
...
<TouchableOpacity style={{padding: 10, borderRadius: 10, backgroundColor: '#ffa914', marginTop: 30, marginBottom:30, alignItems: 'center', marginLeft: 20, marginRight: 20}} onPress={() => navigation.navigate('Signup')}>
