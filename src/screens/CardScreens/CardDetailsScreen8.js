...
const CardDetailsScreen8= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/donut8.jpg') },
    { id: '2', url: require('../CardScreens/images/donut8a.jpg') },
    { id: '3', url: require('../CardScreens/images/donut8.jpg') },
  ...
  const [productName, setProductName] = useState('Pack of 2 Chocolate Donuts'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Pack of 2 Chocolate Donuts</Text>
  ...
  export default CardDetailsScreen8