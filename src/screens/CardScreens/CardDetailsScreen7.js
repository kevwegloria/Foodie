...
const CardDetailsScreen7= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/donut7.jpg') },
    { id: '2', url: require('../CardScreens/images/donut7a.jpg') },
    { id: '3', url: require('../CardScreens/images/donut7.jpg') },
  ...
  const [productName, setProductName] = useState('Box of 9 Choclate Donuts'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Box of 9 Chocolate Donuts</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $120.00</Text>
  ...
  export default CardDetailsScreen7