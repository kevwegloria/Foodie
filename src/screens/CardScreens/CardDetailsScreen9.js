...
const CardDetailsScreen9= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza.jpg') },
    { id: '2', url: require('../CardScreens/images/pizzaA.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza.jpg') },
  ...
  const [productName, setProductName] = useState('Mozarella Pizza '); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Mozarella Pizza</Text>
  ...
  export default CardDetailsScreen9