...
const CardDetailsScreen13= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza5.jpg') },
    { id: '2', url: require('../CardScreens/images/pizza4a.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza5.jpg') },
  ...
  const [productName, setProductName] = useState('Pizza With Extra Cheese '); 

  const [productPrice, setProductPrice] = useState(62);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Pizza With Extra Cheese </Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $62.00</Text>
  ...
  export default CardDetailsScreen13