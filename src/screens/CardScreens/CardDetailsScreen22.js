...
const CardDetailsScreen22= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/sandwich1.jpg') },
    { id: '2', url: require('../CardScreens/images/sandwich2.jpg') },
  ...
  const [productName, setProductName] = useState('2 Egg and Ham Sandwiches'); 

  const [productPrice, setProductPrice] = useState(25.00);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>2 Egg and Ham Sandwiches</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $25.00</Text>
  ...
  export default CardDetailsScreen22