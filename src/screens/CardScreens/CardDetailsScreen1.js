...
const CardDetailsScreen1= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/donut1.jpg') },
    { id: '2', url: require('../CardScreens/images/donut1a.jpg') },
    { id: '3', url: require('../CardScreens/images/donut1b.jpg') },
  ...
  const [productName, setProductName] = useState('Box of 4 Mixed Donuts'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Box of 4 Mixed Donuts</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $40.00</Text>
  ...
  export default CardDetailsScreen1