...
const CardDetailsScreen20= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/fries1.jpg') },
    { id: '2', url: require('../CardScreens/images/combo.jpg') },
  ...
  const [productName, setProductName] = useState('Fries and Ketchup'); 

  const [productPrice, setProductPrice] = useState(20.00);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Fries and Ketchup</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $20.00</Text>
  ...
  export default CardDetailsScreen20