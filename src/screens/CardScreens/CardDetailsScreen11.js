...
const CardDetailsScreen11= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza3.jpg') },
    { id: '2', url: require('../CardScreens/images/pizza3a.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza3.jpg') },
  ...
  const [productName, setProductName] = useState('Pizza With Bell Peppers '); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Pizza With Bell Peppers</Text>
  ...
  export default CardDetailsScreen11