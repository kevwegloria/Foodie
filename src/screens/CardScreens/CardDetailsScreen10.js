...
const CardDetailsScreen10= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza2.jpg') },
    { id: '2', url: require('../CardScreens/images/pizza1.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza2.jpg') },
  ...
  const [productName, setProductName] = useState('Hawaiian Pizza '); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Hawaiian Pizza</Text>
  ...
  export default CardDetailsScreen10