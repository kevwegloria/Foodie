...
const CardDetailsScreen23= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/burger.jpg') },
  ...
  const [productName, setProductName] = useState('King Size Burger'); 

  const [productPrice, setProductPrice] = useState(40.00);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>King Size Burger</Text>
  ...
  export default CardDetailsScreen23