...
const CardDetailsScreen18= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/noodles2.jpg') },
    { id: '2', url: require('../CardScreens/images/noodles1.jpg') },
  ...
  const [productName, setProductName] = useState('Bean Paste Korean Ramyeon'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Bean Paste Korean Ramyeon </Text>
  ...
  export default CardDetailsScreen18