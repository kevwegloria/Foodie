...
const CardDetailsScreen19= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/combo.jpg') },
    { id: '2', url: require('../CardScreens/images/burger.jpg') },
    { id: '3', url: require('../CardScreens/images/fries1.jpg') },
  ...
  const [productName, setProductName] = useState('Burger, Fries and Chips Combo'); 

  const [productPrice, setProductPrice] = useState(80.00);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Burger, Fries and Chips Combo </Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $80.00</Text>
  ...
  export default CardDetailsScreen19