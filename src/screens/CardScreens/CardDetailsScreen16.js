...
const CardDetailsScreen16= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza8.jpg') },
    { id: '2', url: require('../CardScreens/images/pizza8.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza8.jpg') },
  ...
  const [productName, setProductName] = useState('Pizza With Mixed Toppings'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Pizza With Mixed Toppings </Text>
  ...
  export default CardDetailsScreen16