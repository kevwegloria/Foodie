...
const CardDetailsScreen21= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/sandwich2.jpg') },
    { id: '2', url: require('../CardScreens/images/sandwich1.jpg') },
  ...
  const [productName, setProductName] = useState('Ham Sandwich'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Ham Sandwich</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $15.00</Text>
  ...
  export default CardDetailsScreen21