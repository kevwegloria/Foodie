...
const CardDetailsScreen6= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/donut6.jpg') },
    { id: '2', url: require('../CardScreens/images/donut6a.jpg') },
    { id: '3', url: require('../CardScreens/images/donut6.jpg') },
  ...
  const [productName, setProductName] = useState('Box of Sugar Donuts'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Box of Sugar Donuts</Text>
  ...
  export default CardDetailsScreen6