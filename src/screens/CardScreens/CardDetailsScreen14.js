...
const CardDetailsScreen14= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza6.jpg') },
    { id: '2', url: require('../CardScreens/images/pizza3a.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza6.jpg') },
  ...
  const [productName, setProductName] = useState('Pizza With Meat Stuffing and Tomato Slices '); 
  ...
  return (
   <SafeAreaView style={{flex: 1, paddingTop: 40, backgroundColor: 'white'}}>
    ...
    <Icon
          ...
          style={{fontSize: 20, marginTop:13, marginLeft: 20,  color: '#036db0', }}
        />
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Pizza With Meat Stuffing and Tomato Slices  </Text>
  ...
  export default CardDetailsScreen14