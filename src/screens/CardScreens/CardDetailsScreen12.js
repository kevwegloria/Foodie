...
const CardDetailsScreen12= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/pizza4.jpg') },
    { id: '2', url: require('../CardScreens/images/pizza4a.jpg') },
    { id: '3', url: require('../CardScreens/images/pizza4.jpg') },
  ...
  const [productName, setProductName] = useState('Flat Bread Pizza With Cheese '); 

  const [productPrice, setProductPrice] = useState(57);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Flat Bread Pizza With Cheese</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $57.00</Text>
  ...
  export default CardDetailsScreen12