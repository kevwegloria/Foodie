...
const CardDetailsScreen5= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/donut5.jpg') },
  ...
  const [productName, setProductName] = useState('Box of Chocolate Donuts'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Box of Chocolate Donuts</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $60.00</Text>
  ...
  export default CardDetailsScreen5