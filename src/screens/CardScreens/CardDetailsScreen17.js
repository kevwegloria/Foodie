...
const CardDetailsScreen17= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/noodles1.jpg') },
    { id: '2', url: require('../CardScreens/images/noodles2.jpg') },
  ...
  const [productName, setProductName] = useState('Delicious Japanese Ramen'); 

  const [productPrice, setProductPrice] = useState(40.20);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Delicious Japanese Ramen </Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $40.20</Text>
  ...
  export default CardDetailsScreen17