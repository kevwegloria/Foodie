...
const CardDetailsScreen4= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/donut4.jpg') },
    { id: '2', url: require('../CardScreens/images/donut1a.jpg') },
    { id: '3', url: require('../CardScreens/images/donut4.jpg') },
  ...
  const [productName, setProductName] = useState('Box of Pink Donuts'); 
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Box of 4 Pink Donuts</Text>
  ...
  export default CardDetailsScreen4