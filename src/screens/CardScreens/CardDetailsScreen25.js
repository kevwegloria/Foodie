...
const CardDetailsScreen25= ({navigation}) => {
  ...
  const images = [
    { id: '1', url: require('../CardScreens/images/icecream.jpg') },
  ...
  const [productName, setProductName] = useState('Nutty Ice Cream'); 

  const [productPrice, setProductPrice] = useState(30.35);
  ...
  <View style={{ flexDirection: 'row', alignItems: 'center', marginRight: 25, marginTop: 13 }}>
    ...
    <Text style={{ fontSize: 16, marginLeft: 5, fontFamily: 'LondrinaSolid-Regular' }}>
     ...
     <Text style={{ fontFamily: 'Montserrat', fontSize: 20,  fontWeight: 'bold'}}>Nutty Ice Cream</Text>
      <Text style={{fontFamily: 'LondrinaSolid-Regular', color: '#ffa914', fontSize: 15, marginBottom: 10}}>Price: $30.35</Text>
  ...
  export default CardDetailsScreen25